...
define whos turn method
  if level counter odd
    player turn = 1
  else
    player turn = 2

define random question method 
  random number1  random number2  correct answer >> game hash

define compare answer method
  if player answer not correct
    run player death method
  else
    player score + 100
    run next level method


define player death method
  if lives greater than 1
    -1 life
    run next level
  else 
...
define new game method
  display rules
  run new level method 

define level method
  +1 level counter >> global hash
  run whos_turn method
  run random question method
  run display question method
  run player attempt method
  
define display question method
  display question from game hash

define player attempt method
  player input 
  run compare answer method
